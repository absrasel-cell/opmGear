  ...
  return (
    <div className="mt-20">
      <div className="mb-12 text-center">
        ...
        <p className="text-lg text-stone-300 max-w-2xl mx-auto font-sans">
      ...
      <div className="text-center mt-12">
        <Link
          ...
          className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full glass-button glass-hover text-white font-medium font-sans transition-all hover:scale-105"
        >
