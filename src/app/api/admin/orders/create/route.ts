...
export async function POST(request: NextRequest) {
 try {
  ...
  console.log('👤 Admin user:', profile.email);
  ...
  console.log('🎯 Admin recording options:', recordingOptions);
  ...
  if (!result.success) {
   console.error('❌ Admin order creation failed:', result.errors);
  ...
  console.log('✅ Admin order created successfully:', result.orderId);
