...
export async function POST(request: NextRequest) {
 try {
  ...
  console.log('👤 Wholesale user:', profile.email);
  console.log('📄 Order data:', Object.keys(rawOrderData));
  console.log('📦 Bulk order:', rawOrderData.isBulkOrder || false);
  ...
  console.log('🎯 Wholesale recording options:', recordingOptions);
  ...
  if (!result.success) {
   console.error('❌ Wholesale order creation failed:', result.errors);
  ...
  console.log('✅ Wholesale order created successfully:', result.orderId);
