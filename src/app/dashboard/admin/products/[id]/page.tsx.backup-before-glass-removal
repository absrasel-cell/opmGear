        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 pb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              {/* Main Image */}
              <div className="rounded-2xl bg-white/[0.08] border border-white/20 ring-1 ring-white/[0.08] backdrop-blur-2xl overflow-hidden shadow-2xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    ...
                    <button
                      ...
                      className={`rounded-xl bg-white/[0.08] border-2 ring-1 ring-white/[0.08] backdrop-blur-2xl overflow-hidden shadow-xl transition-all duration-200 hover:border-lime-400/50 hover:shadow-2xl hover:-translate-y-1 ${
            ...
            <div className="space-y-8">
              {/* Basic Info */}
              <div className="rounded-2xl bg-white/[0.08] border border-white/20 ring-1 ring-white/[0.08] backdrop-blur-2xl p-6 shadow-2xl">
                <div className="space-y-4">
              ...
              {product.customOptions && product.customOptions.length > 0 && (
                <div className="space-y-6">
                  {product.customOptions.map((option, optionIndex) => (
                    <div key={optionIndex} className="rounded-2xl bg-white/[0.08] border border-white/20 ring-1 ring-white/[0.08] backdrop-blur-2xl p-6 shadow-2xl">
                                ...
                                <label className="cursor-pointer">
                                  ...
                                  <div className={`p-3 rounded-xl border-2 transition-all duration-200 ${
                                    selectedOptions[optionIndex] === textOpt.label
                                      ...
                                      : 'border-white/20 hover:border-white/40 bg-white/[0.05] hover:bg-white/[0.1]'
                                  }`}>
                                    <div className="text-center">
