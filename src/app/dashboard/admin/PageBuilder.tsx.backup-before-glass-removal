    ...
    <div className="space-y-6">
        ...
        <div className="flex space-x-3">
          ...
          {selectedPage && (
            <Button
              ...
              className={previewMode ? "bg-lime-400 text-black hover:bg-lime-300" : "border-white/10 bg-white/5 text-white hover:bg-white/10"}
            >
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center space-x-2">
                        ...
                        {page.isHomePage && (
                          <Badge className="text-xs bg-blue-500/20 text-blue-300 border-blue-500/30">🏠 Home</Badge>
                        )}
                        {page.isPublished && (
                          <Badge className="text-xs bg-green-500/20 text-green-300 border-green-500/30">✅ Published</Badge>
                        )}
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-white/10 bg-black/30 text-white rounded-lg focus:ring-2 focus:ring-lime-400 focus:border-lime-400 disabled:bg-white/5"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-1">
                    ...
                    {selectedPage.sections.map((section, index) => (
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Badge className={section.isVisible ? "bg-green-500/20 text-green-300 border-green-500/30" : "bg-slate-500/20 text-slate-300 border-slate-500/30"}>
      ...
      {isCreatingPage && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-black/80 backdrop-blur-xl border border-white/10 rounded-lg p-6 w-full max-w-md">
