   ...
   <div className="flex">
    ...
    <DashboardContent>
        ...
        <button
         ...
         className={`whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm ${
          currentView === 'overview'
           ...
           : 'border-transparent text-slate-400 hover:text-white hover:border-stone-400'
         }`}
        >
         Overview
        </button>
     ...
     {currentView === 'overview' && (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
         ...
         <GlassCard className="p-5 hover:-translate-y-0.5 transition will-change-transform">
          <div className="flex items-start justify-between">
           ...
           <span className="h-10 w-10 rounded-xl grid place-items-center bg-lime-400/15 border border-lime-400/20 text-lime-300 ring-1 ring-stone-700 animate-pulse">
         ...
         <GlassCard className="p-5 hover:-translate-y-0.5 transition cursor-pointer" onClick={() => setCurrentView('orders')}>
          <div className="flex items-start justify-between">
           ...
           <Button
            variant="ghost"
            className="px-3 py-1.5 rounded-full bg-stone-700 border border-stone-600 text-xs hover:bg-orange-400/10"
           >
            Status: All
           </Button>
          </div>
      ...
      <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
       <div className="border border-stone-600 bg-stone-700 ring-1 ring-stone-700 overflow-hidden rounded-lg">
    ...
    {currentView === 'orders' && (
     <div className="mt-8 px-4 sm:px-0">
         ...
         <button
          ...
          className={`px-3 py-2 rounded-md text-sm font-medium ${
           orderFilter === filter
            ...
            : 'border border-stone-600 bg-stone-700 text-slate-300 hover:bg-stone-600'
          }`}
         >
      ...
      {/* Orders List */}
      <div className="border border-stone-600 bg-stone-700 ring-1 ring-stone-700 shadow rounded-lg">
            ...
            {expandedOrder === order.id && (
             <div className="mt-4 pt-4 border-t border-stone-600">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
               {/* Order Information */}
               <div className="border border-stone-600 bg-stone-700 rounded-lg p-4">
                 ...
                 <div>
                  ...
                  <dd className="text-sm text-white">
                   <select
                    ...
                    className="text-sm border border-stone-600 rounded px-2 py-1 bg-black/30 text-white"
                   >
                  ...
                  <div className="mt-4 pt-3 border-t border-gray-200">
                   ...
                   <dd className="text-sm text-white">
                    <input
                     ...
                     className="w-full text-sm border border-stone-600 rounded px-2 py-1 bg-black/30 text-white focus:outline-none focus:ring-1 focus:ring-lime-400 focus:border-lime-400"
              ...
              <div className="mt-4 pt-4 border-t border-stone-600 flex space-x-3">
               <button 
                onClick={() => updateOrderStatus(order.id, 'PROCESSING')}
                disabled={order.status === 'PROCESSING' || isUpdatingStatus === order.id}
                className="inline-flex items-center px-3 py-2 border border-stone-600 shadow-sm text-sm leading-4 font-medium rounded-md text-white bg-stone-700 hover:bg-stone-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lime-400 disabled:opacity-50"
               >
                Mark Processing
               </button>
               <button 
               ...
               <a
                ...
                className="inline-flex items-center px-3 py-2 border border-stone-600 shadow-sm text-sm leading-4 font-medium rounded-md text-white bg-stone-700 hover:bg-stone-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lime-400"
               >
                Email Customer
               </a>
              </div>
