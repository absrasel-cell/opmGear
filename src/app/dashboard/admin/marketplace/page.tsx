    ...
    <div className="min-h-screen bg-black text-slate-200 flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="hidden md:block">
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white/[0.08] border border-white/20 text-white font-semibold text-sm hover:bg-white/[0.15] hover:border-white/30 backdrop-blur-md transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-400/50 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                >
        ...
        <div className="md:hidden max-w-[1950px] mx-auto px-6 mt-4">
          <Link
            href="/dashboard/admin"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/[0.08] border border-white/20 text-white font-semibold text-sm hover:bg-white/[0.15] hover:border-white/30 backdrop-blur-md transition-all duration-300"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
            </svg>
                ...
                <div className="rounded-2xl bg-white/[0.08] border border-white/20 ring-1 ring-white/[0.08] backdrop-blur-2xl p-5 shadow-2xl">
                  ...
                  <div className="mt-4 relative">
                    <input
                      ...
                      className="w-full h-11 pl-10 pr-4 rounded-xl bg-white/[0.08] border border-white/20 ring-1 ring-white/[0.08] backdrop-blur-2xl text-sm text-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#84cc16]/50 focus:border-[#84cc16]/30 transition-all duration-200 shadow-lg hover:bg-white/[0.12] hover:border-white/30"
                    />
                      ...
                      >
                        ...
                        <div className="relative">
                          ...
                          <div className="absolute top-3 right-3">
                            <div className="w-10 h-10 rounded-full bg-white/10 border border-white/20 backdrop-blur-md flex items-center justify-center overflow-hidden">
                              {vendorName === 'OPM Gear' ? (
                              ...
                              <span className="hidden text-xs font-bold text-white/70">{vendorName.charAt(0)}</span>
                            </div>
                          </div>
                          ...
                          <div className="absolute top-3 left-3 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-black/60 border border-white/20 text-xs text-white font-semibold backdrop-blur-sm">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="min-w-0">
                              ...
                              <div className="mt-0.5 flex items-center gap-2">
                                <span className="text-sm font-semibold text-white/90 drop-shadow-sm">{vendorName}</span>
