...
export default function BillingDashboard() {
 ...
 return (
  <DashboardShell>
     ...
     <section className="px-6 md:px-10 mt-6">
      <GlassCard className="overflow-hidden">
       <div className="p-6 sm:p-8">
        ...
        {/* Tabs */}
        <div className="flex items-center gap-2 border-b border-stone-600 mb-6">
         <button
          ...
          className={`relative inline-flex items-center gap-2 px-4 py-3 text-[15px] border-b-2 font-medium transition ${
           currentTab === 'invoices'
            ...
            : 'border-transparent text-slate-300/90 hover:text-white hover:border-stone-400'
          }`}
         >
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-3 justify-between">
           <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="relative">
             ...
             <input 
              type="date" 
              className="w-[190px] rounded-lg bg-stone-700 border border-stone-600 text-slate-200 focus:outline-none focus:ring-2 focus:ring-cyan-400/40 px-10 py-2.5"
             />
            </div>
           </div>
          </div>
               ...
               <div key={order.id} className="grid grid-cols-12 items-center px-4 sm:px-5 py-3 hover:bg-white/3 transition">
                <div className="col-span-5 sm:col-span-4 flex items-center gap-3">
                 <label className="inline-flex items-center">
                  ...
                  />
                  <span className="mr-2 h-5 w-5 rounded-md border border-stone-500 bg-stone-700 flex items-center justify-center peer-checked:border-lime-400/60 peer-checked:bg-lime-400/20 transition">
           ...
           <div className="col-span-12 lg:col-span-4">
            <div className="rounded-xl bg-stone-700 border border-stone-600 p-5">
              ...
              <div className="flex items-center justify-between text-[15px]">
               ...
               <div className="relative">
                <input 
                 ...
                 className="w-32 text-right rounded-md bg-stone-700 border border-stone-600 pl-3 pr-8 py-2 text-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-400/40"
                />
              ...
              <div className="flex items-center justify-between text-[15px]">
               ...
               <div className="relative">
                <input 
                 ...
                 className="w-32 text-right rounded-md bg-stone-700 border border-stone-600 pl-8 pr-3 py-2 text-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-400/40"
                />
                <span className="absolute left-3 top-2.5 text-slate-400 text-sm pointer-events-none">$</span>
               </div>
              </div>
              <div className="h-px w-full bg-stone-600 my-2"></div>
             ...
             <div className="mt-5 flex items-center gap-3">
              <Button 
               variant="ghost" 
               className="bg-white/7.5 border border-stone-600 flex-1"
               onClick={() => showToast('Template saved')}
              >
               <Save className="h-5 w-5 mr-2" />
               Save Template
          ...
          <div className="col-span-12 md:col-span-6">
           <div className="rounded-xl bg-stone-700 border border-stone-600 p-5 h-full">
            ...
            <div className="space-y-4">
             ...
             <div className="h-px w-full bg-stone-600"></div>
     ...
     <section className="px-6 md:px-10 mt-6">
      <GlassCard className="overflow-hidden">
       <div className="p-6 sm:p-8">
        ...
        <div className="rounded-xl bg-stone-700 border border-stone-600 overflow-hidden">
         <div className="flex flex-col sm:flex-row sm:items-center justify-between px-4 sm:px-6 py-4 border-b border-stone-600 gap-4">
          ...
          <div className="relative">
           <input 
            ...
            className="w-full sm:w-80 rounded-lg bg-stone-700 border border-stone-600 text-slate-200 placeholder:text-slate-400/70 focus:outline-none focus:ring-2 focus:ring-cyan-400/40 pl-12 pr-4 py-3"
           />
           ...
           {filteredPartners.map((partner, index) => (
            <div key={partner.id} className="grid grid-cols-12 gap-6 items-center px-4 sm:px-6 py-5 hover:bg-white/3 transition min-w-[800px]">
             ...
             <div className="col-span-1">
              <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-[12px] font-medium whitespace-nowrap ${
               partner.status === 'Active' 
                ...
                ? 'bg-orange-400/15 text-orange-300 border border-orange-500'
             ...
             <div className="col-span-1 flex items-center justify-end gap-3">
              <button 
               className="rounded-full p-2.5 bg-stone-700 border border-stone-600 hover:bg-stone-600 hover:border-stone-500 transition"
               onClick={() => {
      ...
      <GlassCard className="overflow-hidden">
       <div className="p-6 sm:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
         {/* Toggle */}
         <div className="flex items-center justify-between rounded-xl bg-stone-700 border border-stone-600 p-4">
          <div>
          ...
          <button 
           ...
           className="group relative inline-flex h-10 w-20 items-center rounded-full bg-stone-600 border border-stone-600 transition hover:shadow hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-purple-400"
          >
           <span 
         ...
         {/* Source Information */}
         <div className="rounded-xl bg-stone-700 border border-stone-600 p-4">
          ...
          <div className="rounded-xl bg-stone-700 border border-stone-600 p-4">
           ...
           <div className="relative">
            ...
            <select 
             ...
             className="appearance-none w-full rounded-lg bg-stone-700 border border-stone-600 text-slate-200 focus:outline-none focus:ring-2 focus:ring-purple-400/40 pl-12 pr-12 py-3 "
             style={{
        ...
        <div className="rounded-xl bg-stone-700 border border-stone-600 overflow-hidden">
         {/* Table Header */}
         <div className="bg-white/2.5 border-b border-stone-600 px-6 py-4">
         ...
         <div className="divide-y divide-white/10">
              ...
              <div className="col-span-2">
               <div className="relative">
                ...
                <input 
                 ...
                 className="w-full text-center rounded-lg bg-stone-700 border border-stone-600 pl-10 pr-6 py-3 text-slate-200 focus:outline-none focus:ring-2 focus:ring-cyan-400/40 focus:border-cyan-400/40"
                />
               </div>
              </div>
              ...
              <div className="col-span-3">
               <div className="relative">
                <input 
                 ...
                 className="w-full text-center rounded-lg bg-stone-700 border border-stone-600 pl-6 pr-10 py-3 text-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-400/40 focus:border-orange-400/40"
                />
              ...
              <div className="col-span-3">
               <div className="relative">
                ...
                <input 
                 ...
                 className="w-full text-center rounded-lg bg-stone-700 border border-stone-600 pl-10 pr-6 py-3 text-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-400/40 focus:border-orange-400/40"
                />
               </div>
              </div>
             </div>
          ...
          {/* See More Button */}
          <div className="border-t border-stone-600 px-6 py-4 bg-white/2.5">
           <button
         ...
         {showDetailedCustomization && (
          <div className="mt-4 rounded-xl bg-stone-700 border border-stone-600 overflow-hidden">
           {/* Header */}
           <div className="bg-white/2.5 border-b border-stone-600 px-6 py-4">
           ...
           <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             {/* Logo Options */}
             <div className="space-y-4">
              <h5 className="text-slate-200 text-[14px] font-medium border-b border-stone-600 pb-2">Logo Options</h5>
              ...
              {[
               ...
               <div key={`logo-${idx}`} className="grid grid-cols-8 gap-2 items-center p-3 rounded-lg bg-white/2.5 hover:bg-stone-700 transition">
                ...
                <div className="col-span-2">
                 <div className="relative">
                  ...
                  <input 
                   ...
                   className="w-full text-xs text-center rounded bg-stone-700 border border-stone-600 pl-5 pr-2 py-1.5 text-slate-200 focus:outline-none focus:ring-1 focus:ring-cyan-400/40"
                  />
                 </div>
                </div>
                <div className="col-span-2">
                 <div className="relative">
                  <input 
                   ...
                   className="w-full text-xs text-center rounded bg-stone-700 border border-stone-600 px-2 pr-5 py-1.5 text-slate-200 focus:outline-none focus:ring-1 focus:ring-orange-400/40"
                  />
                ...
                <div className="col-span-1">
                 <div className="relative">
                  ...
                  <input 
                   ...
                   className="w-full text-xs text-center rounded bg-stone-700 border border-stone-600 pl-3 pr-1 py-1.5 text-slate-200 focus:outline-none focus:ring-1 focus:ring-orange-400/40"
                  />
                 </div>
                </div>
               </div>
             ...
             <div className="space-y-4">
              <h5 className="text-slate-200 text-[14px] font-medium border-b border-stone-600 pb-2">Accessories & Others</h5>
              ...
              {[
               ...
               <div key={`accessory-${idx}`} className="grid grid-cols-8 gap-2 items-center p-3 rounded-lg bg-white/2.5 hover:bg-stone-700 transition">
                <div className="col-span-3 text-[13px] text-slate-300">{item.name}</div>
                <div className="col-span-2">
                 <div className="relative">
                  <span className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-500 text-xs">$</span>
            ...
            {/* Delivery Options */}
            <div className="mt-6">
             <h5 className="text-slate-200 text-[14px] font-medium border-b border-stone-600 pb-2 mb-4">Delivery Options</h5>
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
               ...
               <div key={`delivery-${idx}`} className="p-4 rounded-lg bg-white/2.5 hover:bg-stone-700 transition">
                ...
                <div className="space-y-2">
                 <div className="relative">
                  ...
                  <input 
                   ...
                   step="0.01" 
                   defaultValue={item.factory}
                   className="w-full text-xs text-center rounded bg-stone-700 border border-stone-600 pl-5 pr-2 py-2 text-slate-200 focus:outline-none focus:ring-1 focus:ring-cyan-400/40"
                  />
                 </div>
                 <div className="grid grid-cols-2 gap-2">
                  <div className="relative">
                   ...
                   <input 
                    ...
                    step="0.5" 
                    defaultValue={item.percent}
                    className="w-full text-xs text-center rounded bg-stone-700 border border-stone-600 px-1 py-2 text-slate-200 focus:outline-none focus:ring-1 focus:ring-orange-400/40"
                   />
                  </div>
                  <div className="relative">
                   ...
                   <input 
                    ...
                    step="0.01" 
                    defaultValue={item.flat}
                    className="w-full text-xs text-center rounded bg-stone-700 border border-stone-600 pl-3 pr-1 py-2 text-slate-200 focus:outline-none focus:ring-1 focus:ring-orange-400/40"
                   />
                  </div>
                 </div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
         {/* Live Preview */}
         <div className="rounded-xl bg-stone-700 border border-stone-600 p-6">
          <div className="flex items-center justify-between mb-4">
    ...
    <div className="fixed inset-0 z-50">
     ...
     <div className="relative mx-auto max-w-2xl mt-20 rounded-2xl bg-stone-700 border border-stone-600 p-6 sm:p-8 text-slate-200 shadow-2xl">
      ...
      <div className="rounded-xl bg-stone-700 border border-stone-600 p-5 text-[15px]">
       ...
       <div className="h-px w-full bg-stone-600 my-4"></div>
       <div className="flex items-center justify-between">
   ...
   {partnerModalOpen && (
    <div className="fixed inset-0 z-50">
     <div className="absolute inset-0 bg-black" onClick={() => setPartnerModalOpen(false)} />
     <div className="relative mx-auto max-w-xl mt-24 rounded-2xl bg-stone-700 border border-stone-600 p-6 sm:p-8 text-slate-200 shadow-2xl">
      <div className="flex items-center justify-between mb-4">
       <div className="flex items-center gap-2">
      ...
      <div className="grid grid-cols-12 gap-4">
       <div className="col-span-12">
        ...
        <input 
         ...
         className="w-full rounded-lg bg-stone-700 border border-stone-600 px-4 py-2.5 text-slate-200 focus:outline-none focus:ring-2 focus:ring-cyan-400/40"
        />
       </div>
