...
export default function BillingDashboard() {
 ...
 const getStatusColor = (status: string) => {
  switch (status) {
   ...
   case 'REFUNDED':
    return 'bg-orange-400/15 text-orange-300 border-orange-500';
   default:
                 ...
                 {!order.hasInvoice ? (
                  ...
                  <div className="flex gap-1.5">
                   <Button
                    ...
                    className="bg-orange-500/10 border border-orange-500 hover:bg-orange-500/20 text-orange-300 text-xs px-3 py-1.5 whitespace-nowrap"
                   >
       ...
       <div className="space-y-3">
        ...
        <div className="bg-stone-700 border border-stone-600 rounded-lg p-3">
         ...
         <div className="space-y-1 text-xs">
          ...
          <div className="flex justify-between text-slate-200 font-medium border-t border-stone-600 pt-1">
           <span>Total:</span>
           <span>
